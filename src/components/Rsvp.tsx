...
const Rsvp: React.FC<RsvpProps> = () => {
  ...
  const [isComingAnswer, setIsComingAnswer] = useState<boolean | undefined>(
    undefined,
  );
        ...
        <div className="w-11/12 md:w-3/12 h-[fit-content]">
          {rsvpSuccess ? (
            ...
            <>
              ...
              {selectedPerson && (
                <>
                  <select
                    id="location"
                    name="location"
                    className="mt-4 mb-4 block w-full rounded-md border-0 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-[#b8860b] sm:text-sm sm:leading-6"
                    defaultValue="Are you coming?"
                    onChange={(event) => {
                      isComing(event.target.value);
                    }}
                    disabled={codeMatch}
                  >
                    <option value="Are you coming?" selected>
                      Are you coming?
                    </option>
                  ...
                  <div
                    className={`rounded-md mt-2 mb-2 px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-[#b8860b] ${false && " ring-red-300 ring-2 "}`}
                  >
                    <label
                      htmlFor="name"
                  ...
                  {selectedPerson!.numberOfGuests > 1 &&
                    ...
                    selectedPerson!.numberOfGuests !== 903 && (
                      <div>
                        ...
                        {guests && (
                          <div className="mt-3">
                            <span className="text-black text-sm font-semibold leading-6">{`Seats filled: ${guests?.length}/${selectedPerson?.numberOfGuests}`}</span>
                            <ul
                              role="list"
                              ...
                              {guests.map((person) => (
                                ...
                                >
                                  ...
                                  {person.id !== "0" ? (
                                    ...
                                    <button className="rounded-full bg-white px-2.5 py-1 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 cursor-default">
                                      You
                                    </button>
                                  )}
                                </li>
                  ...
                  <div className="rounded-md bg-yellow-50 p-4 mt-6 mb-2">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <h3 className="text-sm font-medium text-yellow-800 pt-3">
                          Who are seat holders
                        </h3>
                        <div className="mt-2 text-sm text-yellow-700">
                          <p>
                            - Adults
                            <br />- Children who are fully capable of eating on
                            their own.
                          </p>
                        </div>
                        <h3 className="text-sm font-medium text-yellow-800 pt-3">
                        ...
                        <div className="mt-2 text-sm text-yellow-700">
                          <p>
                            As much as we would love to celebrate with all of
                            our loved ones, our venue can only accomodate a
                            limited number of people. Thus, we have taken a lot
                            of care in choosing our guest list and organizing
                            the seating arrangement. We hope for your kind
                            understanding and we would greatly appreciate it if
                            you adhere to the number of seats reserved for you.
                          </p>
                        </div>
              ...
              {error &&
                error != "You have reached the maximun number of guests." && (
